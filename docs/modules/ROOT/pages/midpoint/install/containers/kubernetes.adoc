...
:page-moved-from: /midpoint/install/kubernetes/about/, /midpoint/install/kubernetes/advanced-examples/, /midpoint/install/kubernetes/cluster/, /midpoint/install/kubernetes/, /midpoint/install/kubernetes/single-node/
...
image::midpoint/install/containers/kubernetes-diagram.png[]
...
image::midpoint/install/containers/kubernetes-diagram-pvc_secret.png[]
...
.Advanced deployment
image::midpoint/install/containers/kubernetes-diagram-advanced.png[]
...
For details, refer to xref:midpoint::reference/deployment/clustering-ha/index.adoc[].
...
* xref:midpoint::reference/security/crypto/migrating-encryption-keys/index.adoc[]
* xref:midpoint::reference/security/crypto/index.adoc[]
...
For details, refer to xref:midpoint::reference/security/crypto/ssl-connections-client-side-/index.adoc[].
...
* xref:midpoint/install/post-install-orientation/index.adoc[]
