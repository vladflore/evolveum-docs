...
MidPoint users are advised to upgrade their deployments to the latest builds from the xref:midpoint/install/bare-installation/using-support-branch/index.adoc[support branches]. MidPoint 3.6.x users are advised to upgrade to a newer midPoint version.
