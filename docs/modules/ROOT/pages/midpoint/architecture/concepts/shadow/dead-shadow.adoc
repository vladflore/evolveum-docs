...
:page-toc: top
:description: Dead shadows in midPoint track deleted resources, aiding diagnostics and consistency. Learn how they help ensure data integrity in identity management.
