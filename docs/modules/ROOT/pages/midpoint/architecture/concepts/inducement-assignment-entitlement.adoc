...
:page-toc: top
:keywords: inducement, entitlement, assignment
:description: A quick primer to help you understand the differences between inducement, entitlement, and assignment, distinct but interconnected concepts in midPoint
