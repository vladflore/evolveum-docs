...
image::midpoint/architecture/environment.png["Foundational architecture of midPoint"]
...
image::midpoint/architecture/big-picture.png["MidPoint communicates with external systems using connectors"]
...
image::midpoint/architecture/high-level-component-structure.png["High-level component architecture of midPoint"]
